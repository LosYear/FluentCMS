...
class ExtEditMe extends CInputWidget {
	...
	public function init() {
                $this->filebrowserImageBrowseUrl = Yii::app()->baseUrl.'/resources/kcfinder/browse.php?type=images&cms=yii';
                $this->filebrowserImageBrowseLinkUrl = Yii::app()->baseUrl.'/resources/kcfinder/browse.php?type=images&cms=yii';
                $this->filebrowserImageUploadUrl =  Yii::app()->baseUrl.'/resources/kcfinder/upload.php?type=images&cms=yii';
