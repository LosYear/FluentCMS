...
(function($){
    $.fn.jPaginate = function(options) {
        var defaults = {
            ...
            previous: "Previous",
            active: "active",
            pagination_class: "content_pagination pagination",
            minimize: false,
            nav_items: 6,
			cookies: true
        };
        ...
        return this.each(function() {
            ...
            function createPagination(curr) {
				...
				for (i=1;i<=number_of_pages;i++)
                {
                    if (options.minimize == true) {
                        ...
                        if (i == curr) { items += '<li class="active"><a class="'+options.active+'" title="'+i+'">'+i+'</a></li>';}
                        else { items += '<li><a href="#" class="goto" title="'+i+'">'+i+'</a></li>';}
                    }
                }
            ...
            $(".goto_next").live("click", function(e) {
                ...
                var newcurr = parseInt($(".content_pagination").find("a.active").attr("title")) + 1;
