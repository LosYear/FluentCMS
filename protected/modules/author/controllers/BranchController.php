...
class BranchController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Branch'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', Yii::t('AuthorModule.admin', 'Branch "%s" has been created', array('%s' => $model->name)));
    ...
    public function actionUpdate($id)
    {
        ...
        if (isset($_POST['Branch'])) {
            $model->attributes = $_POST['Branch'];
            if ($model->save()) {
                Yii::app()->user->setFlash('success', Yii::t('AuthorModule.admin', 'Branch "%s" has been updated', array('%s' => $model->name)));
                $this->redirect(array('admin'));
            }
        }
