		...
		public function actionNew()
		{
			...
			if (isset($_POST['Mailbox']['to'])) {
				...
				if ($validate) {
					...
					$msg->save();
					Yii::app()->user->setFlash('success', Yii::t('MailboxModule.main', "Message has been sent!"));
					$this->redirect(array('message/inbox'));
				} else {
					Yii::app()->user->setFlash('error', Yii::t('MailboxModule.main', "Error sending message!"));
				}
			} else {
				$conv = new Mailbox();
				if (isset($_GET['id']))
		...
		public function actionReply()
		{
			...
			if (isset($_POST['text'])) {
				...
				if ($validate) {
					$conv->save();
					$reply->save();
					Yii::app()->user->setFlash('success', Yii::t('MailboxModule.main', "Message sent!"));
					$this->redirect(array('message/inbox'));
				} else {
					Yii::app()->user->setFlash('error', Yii::t('MailboxModule.main', "Error sending message!"));
