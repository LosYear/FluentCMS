...
class Results extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, tour_id, points, json', 'required'),
			array('user_id, tour_id, points', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, user_id, tour_id, points, json', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'points' => Yii::t('RushModule.admin','Points'),
			'json' => 'Json',
		);
	}
