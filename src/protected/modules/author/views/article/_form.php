...
<div class="row">
   ...
   <div>
      ...
      ?>
      <div class="column span-12"><?php echo $form->dropDownList($advModel, 'issue_id', $issues,  array('class'=>'span3')); /*textField($model, 'status', array('class'=>'span12'))*/; ?></div>
   </div>
</div>
   ...
   <div>
      ...
      <div class="column span-12"><?php echo $form->dropDownList($model, 'status', 
              array('0' => Yii::t('admin', 'Draft'), 
                  '2'=> Yii::t('authorModule.main', 'Pending')), array('class'=>'span3')) /*textField($model, 'status', array('class'=>'span12'))*/; ?></div>
   </div>
</div>
