<div class="form">
	...
	<div class="row-fluid">
		<div>
			...
			<div class="column span-12"><?php echo CHtml::activeTextField($model,'varname',array('class'=>'span5','size'=>60,'maxlength'=>50,$model->id!==null?'readonly':'')); ?></div>
		</div>
	</div>
	<div class="row-fluid">
		<div>
			<div class="column span-4"><?php echo CHtml::activeLabelEx($model,'title'); ?></div>
			<div class="column span-12"><?php echo CHtml::activeTextField($model,'title',array('class'=>'span5','size'=>60,'maxlength'=>255)); ?></div>
		</div>
	</div>
	<div class="row-fluid">
		<div>
			<div class="column span-4"><?php echo CHtml::activeLabelEx($model,'hint'); ?></div>
			<div class="column span-12"><?php echo CHtml::activeTextField($model,'hint',array('class'=>'span5','size'=>60)); ?></div>
		</div>
	</div>
	<div class="row-fluid">
		<div>
			...
			<div class="column span-12"><?php echo (($model->id)
				...
				: CHtml::activeDropDownList($model,
					'field_type',
					YumProfileField::itemAlias('field_type'), array('class'=>'span5',))); ?></div>
		</div>
	</div>
	<div class="row-fluid">
		<div class="column span-4"><?php echo CHtml::activeLabelEx($model,'field_size'); ?></div>
		<div class="column span-4"><?php echo CHtml::activeTextField($model,'field_size',array('class'=>'span5', $model->id!==null?'readonly':'')); ?></div>
	</div>
	<div class="row-fluid">
		<div class="column span-4"><?php echo CHtml::activeLabelEx($model,'field_size_min'); ?></div>
		<div class="column span-4"><?php echo CHtml::activeTextField($model,'field_size_min', array('class'=>'span5',)); ?></div>
	</div>
	<div class="row-fluid">
		<div class="column span-4"><?php echo CHtml::activeLabelEx($model,'required'); ?></div>
		<div class="column span-4"><?php echo CHtml::activeDropDownList($model,'required',YumProfileField::itemAlias('required'), array('class'=>'span5',)); ?></div>
	</div>
	...
	<div class="row-fluid">
		...
		<div class="column span-4"><?php echo CHtml::activeTextField($model,'position', array('class'=>'span5',)); ?></div>
	</div>
	<div class="row-fluid">
