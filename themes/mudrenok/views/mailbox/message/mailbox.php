  ...
  <div class="row-fluid">
    ...
    <div class="span9 well block">
        <div class="page-header">
            <h1><?php echo Yii::t('MailboxModule.main', 'Mailbox')?> <small><?php echo Yii::t('MailboxModule.main', ucfirst($this->getAction()->getId())); ?></small></h1>
        </div>
<?php
...
$emptyText = 'You have no mail in your '.$this->getAction()->getId().' folder.';
...
$this->widget('bootstrap.widgets.TbListView', array(
    ...
    'itemView'=>'_list',
    'itemsTagName'=>'table',
    'template'=>''.$ie6br.'<div id="mailbox-items" class="ui-helper-clearfix">{items}</div>{pager}',
    ...
    'emptyText'=>'<div style="width:100%"><h3>'.Yii::t('MailboxModule.main', $emptyText).'</h3></div>',
...
<div style="clear:left"> <span class="mailbox-buttons-label"><?php echo Yii::t('MailboxModule.main', 'With selected');?>:</span> 
	...
	<input type="submit" id="mailbox-action-delete" class="btn mailbox-button" name="button[delete]" value="<?php echo Yii::t('MailboxModule.main', 'Delete');?>" /> 
			<?php endif; ?>
	<input type="submit" id="mailbox-action-read" class="btn mailbox-button" name="button[read]" value="<?php echo Yii::t('MailboxModule.main', 'Read');?>" /> 
	<input type="submit" id="mailbox-action-unread" class="btn mailbox-button" name="button[unread]" value="<?php echo Yii::t('MailboxModule.main', 'Unread');?>" /> 
		<?php endif; ?>
</div>
	<?php endif; ?>
	</div>
