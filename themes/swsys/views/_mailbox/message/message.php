...
<div class="mailbox-message-list">
	<div class="page-header">
		<h1><?php echo Yii::t('MailboxModule.main', 'Mailbox') ?>
	...
	<?php
		...
		foreach ($conv->messages as $msg):
			...
			<div class="mailbox-message-header">
				...
				<div
					class="message-date"><?php echo Yii::app()->dateFormatter->formatDateTime($msg->created, 'long', 'short');; ?></div>
				<br/>
			</div>
			...
			<div class="mailbox-message-reply ui-helper-clearfix">
				...
				<div class="mailbox-textarea-wrap ui-helper-clearfix">
					<textarea name="text" cols="50" rows="7"
					          placeholder="<?php echo Yii::t('MailboxModule.main', 'Reply here...'); ?>"></textarea>
				</div>
				<input type="submit" class="btn btn-large mailbox-input"
				       value="<?php echo Yii::t('MailboxModule.main', 'Send Reply'); ?>"/>
			</div>
