...
<article class="main ym-clearfix">
    <div class="article">
            ...
            <div>
                ...
                <div class="article-aside-content">
                    ...
                    <?php if ($advModel->pdf != null): ?>
                        <a href="<?= Yii::app()->createUrl('author/article/downloadPDF', array('id' => $advModel->node_id)) ?>"><span
                                class="glyphicon glyphicon-download-alt"></span>&nbsp;<?= Yii::t('AuthorModule.main', 'Download article in PDF') ?>
                        </a>
                    <?php endif; ?>
        ...
        <ul class="breadcrumbs">
            <li><a href="<?php echo Yii::app()->homeUrl; ?>"><?= Yii::t('AuthorModule.main', 'Home') ?></a> <span
