...
<div class="ym-wrapper">
    <div class="ym-wbox">
        <header class="header ym-clearfix">
            <a href="<?php echo Yii::app()->homeUrl . MultilangHelper::addLangToUrl(''); ?>"><h1>Электронный научный
                    журнал: Программные продукты, системы и
                    алгоритмы</h1></a>
            ...
            <div class="block_add-article">
                ...
                <a href="<?php echo Yii::app()->createUrl('author/article/create'); ?>"
                   class="link text_add-article"><?= Yii::t('journal', 'Create article') ?></a><br>
                ...
                <?php if (Yii::app()->user->isGuest): ?>
                    <a href="<?php echo Yii::app()->createUrl('user/login'); ?>"
                       class="btn"><?= Yii::t('journal', 'Sign in'); ?></a>
                ...
                elseif (!Yii::app()->user->isGuest): ?>
                    <a href="<?php echo Yii::app()->createUrl('author/article'); ?>"
                       class="btn"><?= Yii::t('journal', 'Cabinet'); ?></a>
                <?php endif; ?>

                <?php if (!Yii::app()->user->isGuest): ?>
                    <a href="<?php echo Yii::app()->createUrl('user/user/logout'); ?>"
                       class="btn"><?= Yii::t('admin', 'Logout'); ?></a>
                <?php endif; ?>
            </div>
        </header>
        ...
        <footer class="footer ym-clearfix">
            ...
            <div class="footer-content">
                ...
                <p>© <a href="http://cps.tver.ru" target="_blank" class="link">ЗАО НИИ
                        ЦПС</a> Все права на авторские материалы охраняются в соответствии с законодательством РФ.
                    Перепечатка
                    возможна только с разрешения редакции. При цитировании материалов обязательна ссылка на
                    Международный
                    научно-практический журнал "Программные продукты, системы и алгоритмы" (для on-line проектов
                    обязательна
